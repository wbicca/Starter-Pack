...
Present the conclusion, then a concrete next-steps menu: trivial fix → delegate to an implementation agent; tracked
story → `bmad-create-story`; fresh review → `bmad-code-review`. Recommend the
